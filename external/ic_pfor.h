// "Parallel For" utility from https://github.com/castano/icbc/blob/master/ic_pfor.h
// (2022 Sep, 7c46d17). I could have used std::for_each with std::execution::par,
// except it does not exist on Apple Xcode at the time of writing :/
